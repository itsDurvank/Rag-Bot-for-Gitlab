...
# 🧠 Load content
handbook_text = Path("ChatBot/data/direction_final.txt").read_text(encoding="utf-8")
direction_text = Path("ChatBot/data/handbook_cleaned_FULL.txt").read_text(encoding="utf-8")
